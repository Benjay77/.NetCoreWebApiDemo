...
using NetCoreMicroServiceApi.IdentityServer;
using Swashbuckle.AspNetCore.Filters;
using System;
using System.Collections.Generic;
using System.Reflection;

namespace NetCoreMicroServiceApi.Extentions
{
    /// <summary>
    /// 服务扩展方法
    /// </summary>
    public static class ServiceExtensions
    {
        ...
        public static void ConfigureSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(m =>
            {
                ...
                {
                    Title = "NetCoreMicroServiceApi", Version = "V1.0.0.0" ,
                    Description = "Vue项目的后台Api",
                ...
                m.AddSecurityDefinition("oauth2", new OpenApiSecurityScheme
                {
                    ...
                    Flows = new OpenApiOAuthFlows
                    {
                        ...
                        Implicit = new OpenApiOAuthFlow
                        {
                            Scopes = new Dictionary<string, string>
                            {
                                ["NetCoreMicroServiceApi"] = "API - full access" // //指定客户端请求的api作用域。 如果为空，则客户端无法访问
                            },
